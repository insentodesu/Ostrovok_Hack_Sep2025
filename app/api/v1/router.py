...
from app.api.v1.endpoints import applications, auth, users, hotels, program_hotels, inspections
...
api_router.include_router(inspections.router, prefix="/inspections", tags=["Проверки"])